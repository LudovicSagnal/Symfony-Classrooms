...
class Utilisateurs implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'fk_avis', targetEntity: Avis::class)]
    ...
    public function setEmail(string $utilisateur_email): self
    {
    ...
    public function setFirstName(string $utilisateur_prenom): self
    {
